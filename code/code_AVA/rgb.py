...
def main():
    ...
    partition['validation'] = get_AVA_set(classes=classes, filename=root_dir + "AVA_Val_Custom_Corrected.csv")  # IDs for validation
    ...
    # keras-ucf101-rgb-resnet50-newsplit.hdf5
