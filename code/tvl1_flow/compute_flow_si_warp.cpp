...
int main( int argc, char *argv[] )
{
	...
	if (argc > 1) {
        ...
        cout << "GPU_FLOW SETTINGS: " << endl << "\t start_vid: " << start_with_vid << endl << "\t gpuID: " << gpuID << endl << " \t frameSkip: " << frameSkip << endl << " \t vid_path: " << vid_path << endl << " \t out_path: " << out_path << endl;
    }
