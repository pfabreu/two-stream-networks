...
def main():
    ...
    params = {'dim': (224, 224), 'batch_size': 64,
              ...
              'shuffle': False, 'nb_epochs': 70, 'model': 'resnet50', 'email': True,
    ...
    model.load_weights('../models/two_stream_fusion_flowcrop_crop_crop_resnet50_1809131910.hdf5')
    ...
    bestModelPath = "../models/two_stream_fusion_flowcrop_crop_" + filter_type + "_" + params['model'] + "_" + time_str + ".hdf5"
    traincsvPath = "../loss_acc_plots/two_stream_fusion_flowcrop_crop_train_" + filter_type + "_plot_" + params['model'] + "_" + time_str + ".csv"
    valcsvPath = "../loss_acc_plots/two_stream_fusion_flowcrop_crop_val_" + filter_type + "_plot_" + params['model'] + "_" + time_str + ".csv"
