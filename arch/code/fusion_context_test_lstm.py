...
def main():
    ...
    #result_csv = "output_" + params['gen_type'] + "_LSTM_FCfusion_contextGT_" + filter_type + "_" + time_str + ".csv"
    result_csv = "output_" + params['gen_type'] + "_LSTM_FCfusion_context_secondpass_" + filter_type + "_" + time_str + ".csv"
...
#    flow_weights = "../models/flow_resnet50_1806281901.hdf5"
    rgb_weights = "../models/rgb_fovea_resnet50_1806301953.hdf5"
    flow_weights = "../models/flow_resnet50_1806281901.hdf5"
    context_weights = "../models/context_lstm_2048_5_3.hdf5"
    ...
    fusion_context_weights = "../models/fusion_context_fovealstm_resnet50_1809271048.hdf5"
    #nsmodel = FusionContextModel(classes['label_id'], rgb_weights, flow_weights, context_weights)
    NHU = 2048
    timewindow = 5
    neighbours = 3
...
#    flow_dir = "/media/pedro/actv-ssd/flow_"
    ...
    with tf.device('/gpu:0'):
        for testIDS in test_splits:
            ...
            x_test_context_past, x_test_context_future = reshapeX(x_test_context, (timewindow + 1 + timewindow), neighbours * 30)

            predictions = model.predict([x_test_rgb, x_test_flow, x_test_context_past, x_test_context_future], batch_size=params['batch_size'], verbose=1)
