...
def load_split(ids, labels, dim, n_channels, of_len, rgb_dir, flow_dir, filter_type, encoding, train):
    ...
    for i, ID in enumerate(ids):
        ...
        of_frame = 12 + (int(rgb_frame) - 1) * 5
        # Is this the correct format? Yes, the format has to use _
        img_name = rgb_dir + filter_type + \
