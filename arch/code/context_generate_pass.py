...
LOOKBACK = 5
LOOKFORWARD = 5
INPATHS = ["test_outputs/context_fusion/output_test_ctx_lstmavg_twophase_512_5_3_1809281149.csv"]
OUTPATHS = ["XContext_ThirdPass_test_tw" + str(LOOKBACK) + "_n" + str(NUMBEROFNEIGHBORS) + ".csv"]
