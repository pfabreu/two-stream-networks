...
def rgb_create_model(classes, model_name='inceptionv3', conv_fusion=False):
    ...
    x = Dropout(0.5)(x)  # NOTE Original implementation didn't have dropout
    x = Dense(1024, activation='relu')(x)

    model = None
    preds = Dense(utils.POSE_CLASSES, activation='softmax', name='logits')(x)
