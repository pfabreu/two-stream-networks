...
from context_data import load_split, get_AVA_classes, get_AVA_set, get_AVA_labels
...
def main():
    ...
    classes = get_AVA_classes('ava_action_list_custom.csv')
    ...
    for NHU1, NHU2 in zip(NHU1V, NHU2V):
        ...
        y_v.append(utils.to_binary_vector(y_val_object, size=OBJ_HUMAN_CLASSES, labeltype='object-human'))
        y_v.append(utils.to_binary_vector(y_val_human, size=HUMAN_HUMAN_CLASSES, labeltype='human-human'))
