...
def main():
    ...
    traincsvPath = "plots/rgb_train_plot_" + params['model'] + "_" + time_str + ".csv"
    valcsvPath = "plots/rgb_val_plot_" + params['model'] + "_" + time_str + ".csv"
    ...
    with tf.device('/gpu:0'):
        for epoch in range(params['nb_epochs']):
            ...
            for trainIDS in train_splits:
                ...
                x_train, y_train_pose, y_train_object, y_train_human = load_split(trainIDS, labels_train, params['dim'], params['n_channels'], "train", soft_sigmoid=soft_sigmoid)
            ...
            for valIDS in val_splits:
                ...
                x_val, y_val_pose, y_val_object, y_val_human = load_split(valIDS, labels_val, params['dim'], params['n_channels'], "val", soft_sigmoid=soft_sigmoid)
                y_v = []
