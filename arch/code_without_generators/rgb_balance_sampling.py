...
def main():
    ...
    filter_type = "gauss"
    bestModelPath = "../models/rgb_kininit_" + filter_type + "_" + params['model'] + "_" + time_str + ".hdf5"
    traincsvPath = "../plots/rgb_kininit_train_" + filter_type + "_plot_" + params['model'] + "_" + time_str + ".csv"
    valcsvPath = "../plots/rgb_kininit_val_" + filter_type + "_plot_" + params['model'] + "_" + time_str + ".csv"
    ...
    if params['email']:
        utils.sendemail(from_addr='pythonscriptsisr@gmail.com',
                        ...
                        subject='Finished training RGB-stream augmented',
