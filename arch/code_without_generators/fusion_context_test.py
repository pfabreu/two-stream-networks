...
from fusion_context_data import get_AVA_set, load_split
import time
...
def main():
    ...
    result_csv = "output_" + params['gen_type'] + "_fusion_context_" + filter_type + "_" + time_str + ".csv"
    ...
    context_weights = "../models/context_mlp128.hdf5"
