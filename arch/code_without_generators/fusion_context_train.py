...
def main():
    ...
    bestModelPath = "../models/fusion_context_fovea_" + params['model'] + "_" + time_str + ".hdf5"
    traincsvPath = "../loss_acc_plots/fusion_context_train_fovea_plot_" + params['model'] + "_" + time_str + ".csv"
    valcsvPath = "../loss_acc_plots/fusion_context_val_fovea_plot_" + params['model'] + "_" + time_str + ".csv"
