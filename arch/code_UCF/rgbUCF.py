...
def main():
    ...
    trainlist_path = root_dir_info + "trainlist.pkl"
    ...
    X_Train, y_Train = load_set(annot_path, trainlist_path, data_paths_dict["fovea"], params["dim"], params["n_channels"])
    ...
    saved_weights = None
    saved_weights = "../models/ucf_keras/keras-ucf101-24-rgb-resnet50-split1.hdf5"  # "saved_models/rgb_fovea_resnet50_1806301953.hdf5"
    ...
    # Start the TRAINING
    bestModelPath = "saved_models/rgb_UCF_fovea.hdf5"
    ...
    if sendmail:
        utils.sendemail(from_addr='pythonscriptsisr@gmail.com',
                        ...
                        cc_addr_list=[],
                        subject='Finished training UCF Fovea Resnet 50 RGB-stream ',
